...
# arm limits
ARM_MIN_HEIGHT = 0.0  # Minimum height of the arm (m)
ARM_MAX_HEIGHT = 1.8  # Maximum height of the arm (m)
ARM_MIN_X = -1.0  # Minimum x position of the arm (m)
ARM_MAX_X = 1.0  # Maximum x position of the arm (m)
ARM_MIN_Y = -1.0  # Minimum y position of the arm (m)
ARM_MAX_Y = 1.0  # Maximum y position of the arm (m)
...
ARM_MIN_RADIAL = -1.0  # Minimum radial position of the arm (m)
ARM_MAX_RADIAL = 1.0  # Maximum radial position of the arm (m)
ARM_MAX_LINEAR_VEL = 0.5  # Maximum linear velocity of the arm (m/s)
ARM_MAX_RADIAL_VEL = ARM_MAX_LINEAR_VEL  # Maximum radial velocity of the arm (m/s)
ARM_MAX_VERTICAL_VEL = ARM_MAX_LINEAR_VEL  # Maximum vertical velocity of the arm (m/s)
ARM_MAX_AZIMUTHAL_VEL = np.pi / 4  # Maximum azimuthal velocity of the arm (rad/s)
